...
namespace FIX
{
  ...
  const char YieldType_YIELD_VALUE_OF_1_32[] = "VALUE1/32";
  ...
  const char MassCancelRejectReason_OTHER = '99';
  const char MassCancelRejectReason_INVALID_OR_UNKOWN_UNDERLYING_SECURITY = '2';
  const char MassCancelRejectReason_INVALID_OR_UNKNOWN_SECURITYTYPE = '5';
  const char MassCancelRejectReason_INVALID_OR_UNKNOWN_MARKET = '7';
  const char MassCancelRejectReason_INVALID_OR_UNKOWN_MARKET_SEGMENT = '8';
  const char MassCancelRejectReason_INVALID_OR_UNKNOWN_SECURITY_GROUP = '9';
  const char MassCancelRejectReason_INVALID_OR_UNKNOWN_SECURITY_ISSUER = '10';
  const char MassCancelRejectReason_INVALID_OR_UNKNOWN_ISSUER_OF_UNDERLYING_SECURITY = '11';
