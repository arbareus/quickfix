...
namespace FIX
{
 ...
 const char MsgType_NEWS[] = "B";
 const char MsgType_EMAIL[] = "C";
 const char MsgType_NEW_ORDER_D[] = "D";
 const char MsgType_NEW_ORDER_E[] = "E";
 ...
 const char MsgType_MARKET_DATA_W[] = "W";
 const char MsgType_MARKET_DATA_X[] = "X";
 ...
 const char MsgType_NEW_ORDER_s[] = "s";
 ...
 const char MsgType_NEW_ORDER_AB[] = "AB";
 ...
 const char MsgType_NETWORK_COUNTERPARTY_SYSTEM_STATUS_REQUEST[] = "BC";
 const char MsgType_NETWORK_COUNTERPARTY_SYSTEM_STATUS_RESPONSE[] = "BD";
 ...
 const int EncryptMethod_PKCS_1 = 1;
 const int EncryptMethod_DES = 2;
 const int EncryptMethod_PKCS_3 = 3;
 const int EncryptMethod_PGP_4 = 4;
 const int EncryptMethod_PGP_5 = 5;
